namespace KBEngine
{
    ...
    public class Avatar : KBEngine.GameObject
    {
		...
		public virtual void OnreqTradeDone()
		{
			KBEngine.Event.fireOut("OnreqTradeDone");
			//trade is done
			//cellCall("OnreqTradeItemList", InItem,INmoney);
		}
        //技能
		...
		public virtual void  IsTradeing(Int32 TargetID)
		{
			//open trade windows,and show trade taegetID
			KBEngine.Event.fireOut("OpenTradeWindows",TargetID);
		}

		public virtual void OnreqTradeItemList(Dictionary<string, object> InItem,UInt64 INmoney)
		{
			//show target trade item
			KBEngine.Event.fireOut("OnreqTradeItemList",InItem,INmoney);
		}
		public virtual void OnreqTradeItemList2(UInt64 INmoney)
		{
			//show target trade item
			KBEngine.Event.fireOut("OnreqTradeItemList2",INmoney);
		}
